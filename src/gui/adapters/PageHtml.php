...
class PageHtml extends Mappable
{
    ...
    public function __construct(string $map_name = "default")
    {
        ...
        $this->loadMaps([self::FRAMEWORK_CSS . Kernel::$Environment::GRIDSYSTEM_ADAPTER, self::FONT_ICON . Kernel::$Environment::FONTICON_ADAPTER], self::class);
     ...
     */
    public function setLayout(string $name, string $theme = null) : PageHtml
    {
